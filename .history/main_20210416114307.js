...
function removeItemArray(array , event){
    array.splice(event.target,event);//se le pone 1 porque se quiere eliminar únicamente el <li> que se ha clickado del array
